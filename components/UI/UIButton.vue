...
<template>
    <button @click="click_action" v-if="props.button_type === 'success'" :type="props.type" :class="`w-full ${props.size === 'normal' ? 'p-2' : 'p-2 text-md' } transition font-bold text-white bg-green-500 rounded-md hover:bg-green-400 ${props.custom_class}`"><slot/></button>
