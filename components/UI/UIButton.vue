...
<template>
    <button v-if="props.button_type === 'success'" :type="props.type" :class="`w-full ${props.size === 'normal' ? 'p-2' : 'p-1' } transition font-bold text-white bg-green-500 rounded-md hover:bg-green-400 ${props.custom_class}`"><slot/></button>
    <button v-if="props.button_type === 'default'" :type="props.type" :class="`w-full ${props.size === 'normal' ? 'p-2' : 'p-1' } transition font-bold text-white bg-slate-500 rounded-md hover:bg-slate-400 ${props.custom_class}`"><slot/></button>
