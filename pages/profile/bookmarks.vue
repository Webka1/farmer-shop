...
<template>
    <div>
        ...
        <ItemsEmpty button_enabled="true" image="/img/image_9.svg" image_size="70" class="mt-10" title="Избранных товаров нет :(" description="Вы ничего не добавили в избранные товары" v-else/>
    </div>
</template>